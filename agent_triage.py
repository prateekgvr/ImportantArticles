...
with agents_client:
    ...
    - Infrastructure
    - Marketing
    Base your answer on the content of the ticket.
    Respond with the team name and a very brief explanation.
    """
    ...
    Base your estimate on the complexity implied by the ticket.
    Respond with the effort level and a brief justification.
    """
    ...
    # Create a triage agent that uses the connected agents
    triage_agent = agents_client.create_agent(
        model=model_deployment,
        name="triage-agent",
        instructions="""
        Triage the given ticket. Use the connected tools to determine the ticket's
        priority, which team it should be assigned to, and how much effort it may take.
        """,
        tools=[
